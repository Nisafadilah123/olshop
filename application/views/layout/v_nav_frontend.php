...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
        <a href="#" class="navbar-brand">
            ...
            <span class="brand-text font-weight-light"><b>TOKOKNA</b></span>
        </a>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            ...
                            <li><a href="<?= base_url('home/kategori/' . $value->id_kategori) ?>"
                                    class="dropdown-item"><?= $value->nama_kategori ?> </a></li>
                            <?php } ?>
                    ...
                    <li class="nav-item dropdown">
                        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false" class="nav-link dropdown-toggle">Contact</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li><a href="https://www.instagram.com/karangtarundesakenanga/" class="dropdown-item"><i
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            <li class="nav-item">
                ...
                <a class="nav-link" data-toggle="dropdown" href="#">
                    <img src="<?= base_url('assets/pelanggan/' . $this->session->userdata('foto')) ?>"
                        class="brand-image img-circle elevation-3" width="10px">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <a href="<?= base_url('belanja/chekout') ?>" class="dropdown-item dropdown-footer">Check Out</a>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">TOKOKNA</a></li>
