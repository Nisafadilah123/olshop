...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url() ?>"><b></b>Register Admin</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="input-group mb-3">
                    <input type="text" name="nama_user" class="form-control" placeholder="Nama Admin"
            ...
            <p class="mb-0"> -->
            <a href="<?= base_url('auth/login_user') ?>" class="text-center">Sudah Punya Akun</a>
            <!-- </p> -->
        </div>
        <!-- /.login-card-body -->
    </div>
