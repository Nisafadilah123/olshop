        ...
        <div class="register-box">
            ...
            <div class="card">
                <div class="card-body register-card-body">
                    <p class="login-box-msg">Forgot Password Pelanggan</p>
					...
					echo form_open('pelanggan/email_reset_password_validation'); ?>
                    ...
                    <?php echo form_close(); ?>
                    <a href="<?= base_url('pelanggan/login') ?>" class="text-center">Kembali Login </a><br>
