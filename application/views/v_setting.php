        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Kota</label>
                        <!-- pengambilan data api kota berdasarkan data api provinsi yang dipilih -->
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label>No. Hp</label>
                        <input type="text" name="no_hp" class="form-control" required value="<?= $setting->no_hp ?>">
                    </div>
                </div>
            </div>
